@extends('layouts.app')
@section('metadescription' , 'Hi there and thanks for viewing my website, Im a Web Developer from Portsmouth in the UK. please check out all my social channels and links to videos.')
